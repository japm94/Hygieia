...
import com.capitalone.dashboard.collector.DefaultPhabricatorClient;
...
public class DefaultPhabricatorClientTest {
    ...
    public void init() {
        ...
        client = new DefaultPhabricatorClient(settings, restOperationsSupplier);
    }
	
    @Test
    public void testGetCommits() throws IOException {
    	// Note that there always is paging even if results only take 1 page
    	String jsonResponse1 = getJson("/phabricator-server/response1a.json");
    	String jsonResponse2 = getJson("/phabricator-server/response1b.json");
