 ...
 */
@Component
public class GitCollectorTaskTest extends CollectorTask<Collector> {
    private static final Log LOG = LogFactory.getLog(GitCollectorTaskTest.class);
    ...
    @Autowired
    public GitCollectorTaskTest(TaskScheduler taskScheduler,
        ...
        super(taskScheduler, "Phabricator");
    ...
    private void clean(Collector collector) {
         ...
         * Store their IDs in a unique set ONLY if their collector IDs match with Phabricator collectors ID.
         */
